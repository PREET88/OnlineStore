...
public class ProductList extends Vector {
	...
	private static Item[] items = {
			new Item("hall001", "<I>Core Servlets and JavaServer Pages</I> " + " by Marty Hall",
					...
					39.95),
			new Item("hall002",
					"<I>Core Web Programming, Java2 Edition</I> " + "by Marty Hall, Larry Brown, and " + "Paul McNamee",
					"One stop shopping for the Web programmer. " + "Topics include \n"
							...
							+ "</UL>",
					49.95),
			new Item("lewis001", "<I>The Chronicles of Narnia</I> by C.S. Lewis",
					"The classic children's adventure pitting " + "Aslan the Great Lion and his followers\n"
							...
							+ "<I>The Last Battle</I>.",
					19.95),
			new Item("alexander001", "<I>The Prydain Series</I> by Lloyd Alexander",
					...
					19.95),
			new Item("rowling001", "<I>The Harry Potter Trilogy</I> by " + "J.K. Rowling",
